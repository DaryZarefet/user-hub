...
interface RoleCardProps {
  object: Client;
  openEdit?: (object: Client) => void;
  openDelete?: (object: Client) => void;
}

export const ClientCard = ({ object, openEdit, openDelete }: RoleCardProps) => {
  const { name, id, authenticationMethods, grants } = object;
